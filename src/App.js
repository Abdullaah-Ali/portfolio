...
function App() {
  ...
  return (
    <div className="App">
      <Header />
      <h1 className="header">Hi Syed Abdullah here, Helping Companies Scale</h1>
      <img src={syed} alt="Syed Abdullah" className="image" />

      <p className="description">
        <span>Howdy!</span>
        <br />
        It's Syed Abdullah, Web Developer and aspiring Machine Learning Engineer, aspiring to learn new skills in the
        digital age. I have worked with many Several clients in growing their businesses and am always ready to work for
        you. Working in different environments using different practices fuels my passion, still thriving to face
        challenges and grow.
      </p>
      ...
      {/* Calendly Widget */}
      <div id="info" className="text-2xl font-bold text-center my-8">
