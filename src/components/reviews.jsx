...
<div className="relative max-w-5xl mx-auto mt-12 pb-8"> {/* Added padding-bottom here */}
      ...
      <button
        onClick={handlePrev}
        className="absolute left-4 z-20 p-3 bg-gray-100 rounded-full shadow-md hover:bg-gray-200 transition"
      >
        <ChevronLeft className="w-6 h-6 text-gray-600" />
      </button>
      <button
        onClick={handleNext}
        className="absolute right-4 z-20 p-3 bg-gray-100 rounded-full shadow-md hover:bg-gray-200 transition"
      >
